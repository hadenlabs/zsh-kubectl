<!-- Space: Projects -->
<!-- Parent: ZshKubectl -->
<!-- Title: Contributing GithubFlow ZshKubectl -->
<!-- Label: ZshKubectl -->
<!-- Label: Project -->
<!-- Label: Contributing -->
<!-- Label: GithubFlow -->
...
To contribute to zsh-kubectl project on [GitHub](https://github.com/hadenlabs/zsh-kubectl), We use [GitHub Flow](https://githubflow.github.io/), it means that you should branch from the main repository and contribute back by making [pull request](https://github.com/hadenlabs/zsh-kubectl/pulls).
